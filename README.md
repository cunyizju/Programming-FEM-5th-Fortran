...
I once used Microsoft Windowing Application to present the modelling result. However, the Graphical User Interface (GUI) is not satisfactory. So in this repository, I do not pay attention to visualization. What I focus on are the input and output files,  algorithms, and most importantly, the readibility of the code. [Paraview](https://www.paraview.org/) and [matplotlib](https://matplotlib.org/) may be used if GUI is in need of development in the future.
## Prerequisites  
